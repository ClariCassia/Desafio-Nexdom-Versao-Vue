  ...
  <main class="max-w-5xl mx-auto w-full min-w-0 px-4 sm:px-6 py-12">
    ...
    <div class="bg-transparent md:bg-white md:rounded-2xl md:shadow-xl md:border md:border-slate-100 md:overflow-hidden">
      ...
      <div class="space-y-4 md:space-y-0 md:divide-y md:divide-slate-100 text-sm text-slate-600">
        ...
        <div v-else v-for="solicitacao in store.historicoSolicitacoes" :key="solicitacao.id" class="bg-white rounded-2xl shadow-md border border-slate-100 p-5 md:p-4 md:rounded-none md:shadow-none 
          md:border-0 hover:bg-slate-50/50 transition-colors flex flex-col md:grid md:grid-cols-12 md:gap-4 md:items-center">
          ...
          <div class="flex justify-between items-center border-b border-slate-100 pb-3 mb-3 md:border-0 md:pb-0 md:mb-0 md:contents">
            ...
            <div class="font-mono font-bold text-slate-400 text-xs md:col-span-1 md:text-center md:text-sm">
              ...
              <span class="block text-[9px] font-sans font-normal text-slate-400 mt-0.5">
          ...
          <div class="grid grid-cols-3 gap-2 text-center bg-slate-50/60 p-3 rounded-xl border border-slate-100/80 
            mb-3 md:bg-transparent md:p-0 md:border-0 md:mb-0 md:contents">
